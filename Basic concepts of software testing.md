...
Проверяет, что ПО соответствует заданным требованиям и работает как задумано.
2. **Обнаружение проблем на ранних этапах разработки.**\
Раннее нахождение ошибок упрощает и удешевляет их исправление.
3. **Выявление непредусмотренных вариантов использования.**\
Обнаруживает необычные сценарии использования, которые могут вызвать сбои.
4. **Повышение лояльности к компании и продукту.**\
Качественное ПО вызывает доверие и удовлетворение у пользователей, улучшая репутацию.

## Принципы тестирования

1. **Тестирование демонстрирует наличие дефектов.**\
Тестирование показывает ошибки, но не гарантирует их отсутствие.
2. **Исчерпывающее тестирование невозможно.**\
Нельзя протестировать все возможные сценарии; выбираются наиболее важные.
3. **Раннее тестирование.**\
Начинать тестирование как можно раньше помогает уменьшить затраты на исправление дефектов.
4. **Скопление дефектов.**\
Ошибки часто группируются в одних и тех же участках кода.
5. **Парадокс пестицида.**\
Старые тесты перестают выявлять новые ошибки; их нужно обновлять.
6. **Тестирование зависит от контекста.**\
Подходы к тестированию зависят от типа ПО.
7. **Заблуждение об отсутствии ошибок.**\
Отсутствие видимых ошибок не гарантирует, что ПО полностью удовлетворяет требованиям пользователей.
...
- **Проектная документация** — описывает план и процесс разработки ПО. Включает требования, спецификации, архитектуру системы, графики разработки и тестирования. Помогает команде понять, что и как нужно сделать.
- **Продуктовая документация** — описывает конечный продукт, его функции и использование. Включает пользовательские инструкции, справочные материалы и документацию для поддержки. Помогает пользователям правильно использовать ПО и решать возникающие проблемы.
...
### Тестирование белого ящика
Проверяет внутреннюю логику и структуру кода. Тестировщик знает детали реализации программы и использует это знание для создания тестов, проверяя функциональность и потоки выполнения в коде.

### Тестирование серого ящика
Комбинирует элементы тестирования белого и черного ящика. Тестировщик имеет частичное знание внутренней структуры системы и использует это для проверки как интерфейса, так и внутренней логики.

### Тестирование чёрного ящика
Оценивает функциональность программы без знания ее внутренней структуры. Тестировщик проверяет, как система реагирует на различные входные данные и соответствует ли выходные данные ожидаемым результатам.
