...
## [🌏Типы данных - Data Types1️⃣](#типы-данных) 
...
## [🟡Ключевые концепции ООП6️⃣](#ключевые-концепции-ооп)
...
## [🔵Модификаторы и управление доступом](#модификаторы-и-управление-доступом)
   ...
   - [🔸 Модификаторы доступа - Access Modifiers2️⃣](#модификаторы-доступа)
...
## [🟣Работа с исключениями - Exceptions8️⃣](#работа-с-исключениями)
...
## [🟤Современные API ](#современные-api)
   ...
   - [🔹 Stream API1️⃣2️⃣](#stream-api)
   - [🔹 Лямбда-выражения - Functions(Lambda expressions)9️⃣](#лямбда-выражения)
   - [🔹 Функциональные интерфейсы](#функциональные-интерфейсы)

## [🗂️Коллекции ](#коллекции)
   
   - [🔸 Java Collections и Map7️⃣](#java-collections-и-map)
...
## [🏆Структуры данных и обобщения (Generics)](#generics) 
   ...
   - [🔹 Generics: общее понимание1️⃣1️⃣](#generics-общее-понимание)

## [👑Управление памятью и работа со ссылками](#memory) 

   - [🔸 Память, сборщик мусора - Memory Management, Garbage Collection4️⃣](#память)
...
## [💡Фундаментальные концепции](#фундаментальные) 
   ...
   - [🔹 Базовый синтаксис - Basic Syntax3️⃣](#basic)
   - [🔹 Интерфейсы - Interface5️⃣](#interface)
   - [🔹 Методы](#методы)
   - [🔹 Классы ](#классы)
