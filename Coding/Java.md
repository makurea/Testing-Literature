...
## [🔐 Модификаторы и область видимости](#модификаторы-и-область-видимости)
...
## [🧨 Исключения и ошибки](#исключения-и-ошибки)
...
## [🚀 Современные фичи Java](#современные-фичи-java)
...
## [🧠 JVM, память и производительность](#jvm-память-и-производительность)
...
## [🧵 Многопоточность и конкурентность](#многопоточность-и-конкурентность)
...
## [🔎 Рефлексия и аннотации](#рефлексия-и-аннотации)
...
## [🗃️ Работа с файлами и I/O](#работа-с-файлами-и-io)
...
[🔄 К содержанию - главы](#основы-java)  
...
[🔄 К содержанию - главы](#типы-данных-и-переменные)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#управление-потоком-выполнения)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#модификаторы-и-область-видимости)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#исключения-и-ошибки)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#коллекции-java)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#структуры-данных-и-алгоритмы)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#обобщения-generics)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#современные-фичи-java)  
[▶️ К содержанию](#content)
...
### 🔸 JVM и её архитектура <a id="jvm-архитектура"></a>

[🔄 К содержанию - главы](#jvm-память-и-производительность)  
[▶️ К содержанию](#content)

---

### 🔸 Память: Heap, Stack <a id="память-heap-stack"></a>
...
[🔄 К содержанию - главы](#многопоточность-и-конкурентность)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#рефлексия-и-аннотации)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#работа-с-файлами-и-вводом-выводом)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#сетевое-взаимодействие)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#инструменты-и-экосистема)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#архитектура-и-паттерны)  
[▶️ К содержанию](#content)
...
[🔄 К содержанию - главы](#версии-java)  
[▶️ К содержанию](#content)
