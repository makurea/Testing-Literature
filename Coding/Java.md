...
- Финальный (`final`)  
- Запечатанный (`sealed`, `non-sealed`)  
- Вложенный (`static nested`)  
- Внутренний (`inner`)  
- Локальный (`local`)  
- Анонимный (`anonymous`)  
...
**Виды интерфейсов:**  
- Обычный (`interface`)  
- Функциональный (`@FunctionalInterface`)  
- Маркерный  
- Запечатанный (`sealed`)  
...
- Нативный (`native`)  
- Дефолтный (`default`)  
- Приватный в интерфейсе (`private`)  
- Перегруженный (Overloading)  
- Переопределённый (Overriding)  
