...
## 11. JUnit 5 и AssertJ. Как осуществить параметризацию тестов в JUnit 5?

**JUnit 5** – фреймворк для тестирования на Java, **AssertJ** – библиотека для более читабельных утверждений в тестах.

Пример параметризации тестов в JUnit 5:
```java
@ParameterizedTest
