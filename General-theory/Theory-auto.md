...
## [🟢 Основы автоматизации](#основы-автоматизации)  <a id="-глава"></a>
...
## [🕵️ Тест-раннеры (Test Runners)](#test-runners)  <a id="-глава"></a>

- [JUnit](#junit)
- [TestNG](#testng)
- [Сравнение JUnit и TestNG](#сравнение-junit-testng)

## [📦 Системы сборки](#системы-сборки)  <a id="-глава"></a>

- [Maven](#maven)
- [Gradle](#gradle)
- [Сравнение Maven и Gradle](#сравнение-maven-gradle)

## [🔎 Локаторы](#локаторы)  <a id="-глава"></a>
...
## [🌍 Инициализация браузера](#инициализация-браузера)  <a id="-глава"></a>
...
## [🎭 Selenium ](#selenium)  <a id="-глава"></a>
...
## [⏳ Ожидания в тестах](#ожидания)  <a id="-глава"></a>
...
## [🌐 API Тестирование](#api-тестирование)  <a id="-глава"></a>
...
## [🏛 Архитектура фреймворка](#архитектура)  <a id="-глава"></a>
