...
## Инструменты и технологии <a id="инструменты-и-технологии"></a>

### [🖥️ Языки и платформы](#языки-и-платформы)

- [Java (автоматизированное тестирование)](#java)
...
- [Тестирование SOAP-сервисов](#тестирование-soap-сервисов)  
- [Тестирование мобильных приложений (mobile)](#тестирование-мобильных-приложений)  
- [Тестирование веб-приложений (web)](#тестирование-веб-приложений)  

### [🔧 Инструменты для API и мок-сервисов](#инструменты-для-api-и-мок-сервисов)

- [REST API](#rest-api)  
- [SOAP UI](#soap-ui)  
- [Postman](#postman)  
- [Wiremock (мок-сервисы и аналоги)](#wiremock)  

### [🗃️ Базы данных](#базы-данных)

- [SQL (сложные запросы, JOIN, VIEW и др.)](#sql)  
- [NoSQL](#nosql)  
...
- [Kafka](#kafka)  
- [RabbitMQ](#rabbitmq)  
- [Аналоги Kafka/RabbitMQ](#аналоги-kafka-rabbitmq)  
...
### [🛠️ Системы контроля версий и разработки](#системы-контроля-версий-и-разработки)

- [Git](#git)  
- [Bitbucket](#bitbucket)  
- [IntelliJ IDEA](#intellij-idea)  

### [🕵️ Сниферы трафика](#сниферы-трафика)

- [Wireshark](#wireshark)  
- [Fiddler](#fiddler)  
- [Charles Proxy](#charles-proxy)  

### [➕ Дополнительно (плюсы)](#дополнительно-плюсы)

- [Микросервисная архитектура (Spring Cloud, Kubernetes, Openshift или аналоги)](#микросервисная-архитектура)  
- [Docker и контейнеризация](#docker-и-контейнеризация)  

### [📚 Работа с документацией и таск-трекинг](#работа-с-документацией-и-таск-трекинг)
...
- [Английский Intermediate+ (для чтения технической документации)](#английский)  


## Ответы на инструменты и технологии

### 🖥️ Языки и платформы

#### Java (автоматизированное тестирование) <a id="java"></a>  
Java — один из самых популярных языков программирования для написания автоматизированных тестов. Используется в сочетании с тестовыми фреймворками (JUnit, TestNG), библиотеками для работы с UI (Selenium, Selenide), REST API (Rest Assured) и многими другими. Обеспечивает высокую масштабируемость, поддержку многопоточного тестирования и интеграцию с CI/CD.
...
Проверка соответствия функционала системы требованиям и спецификациям. Включает тестирование всех пользовательских сценариев и бизнес-логики.

[🔼 К содержанию](#content)

---

#### Интеграционное тестирование <a id="интеграционное-тестирование"></a>  
Проверка взаимодействия между разными модулями и сервисами, включая REST API и брокеры сообщений. Позволяет выявить ошибки на стыках компонентов.

[🔼 К содержанию](#content)

---

#### Регрессионное тестирование <a id="регрессионное-тестирование"></a>  
Тестирование, направленное на обнаружение сбоев и ошибок в уже работающем функционале после внесения изменений или обновлений.

[🔼 К содержанию](#content)

---

#### Тестирование REST API <a id="тестирование-rest-api"></a>  
Автоматизированное и ручное тестирование HTTP-запросов, проверка корректности ответов, статус-кодов, заголовков и данных в формате JSON/XML.

[🔼 К содержанию](#content)

---

#### Тестирование SOAP-сервисов <a id="тестирование-soap-сервисов"></a>  
Проверка работы SOAP-веб-сервисов, их WSDL-схем и корректности обмена XML-сообщениями.

[🔼 К содержанию](#content)

---

#### Тестирование мобильных приложений (mobile) <a id="тестирование-мобильных-приложений"></a>  
Проверка функционала и интерфейса приложений на мобильных устройствах, включая Android и iOS, с учетом особенностей платформ и сетевых условий.

[🔼 К содержанию](#content)

---

#### Тестирование веб-приложений (web) <a id="тестирование-веб-приложений"></a>  
Проверка пользовательского интерфейса, совместимости с браузерами, производительности и безопасности веб-приложений.

[🔼 К содержанию](#content)

---

### 🔧 Инструменты для API и мок-сервисов

#### REST API <a id="rest-api"></a>  
Архитектурный стиль для создания веб-сервисов, позволяющий взаимодействовать через HTTP-запросы. Используется для построения интеграционных тестов.

[🔼 К содержанию](#content)

---

#### SOAP UI <a id="soap-ui"></a>  
Инструмент для тестирования SOAP и REST веб-сервисов, поддерживает автоматизацию тестов, функциональные и нагрузочные проверки.
...
Популярный инструмент для разработки и тестирования API с удобным интерфейсом, поддерживает создание коллекций тестов и автоматизацию.

[🔼 К содержанию](#content)

---

#### Wiremock (мок-сервисы и аналоги) <a id="wiremock"></a>  
Инструмент для создания заглушек и моков сервисов, что позволяет изолировать тестируемый компонент и симулировать поведение зависимостей.
...
#### SQL (сложные запросы, JOIN, VIEW и др.) <a id="sql"></a>  
Язык структурированных запросов для работы с реляционными базами данных, используется для валидации данных и сложных выборок.
...
#### NoSQL <a id="nosql"></a>  
Нереляционные базы данных (например, MongoDB, Cassandra), применяются для хранения больших объемов данных и обеспечения масштабируемости.
...
#### Kafka <a id="kafka"></a>  
Распределённая платформа для обработки потоков сообщений, широко используется для построения микросервисов и асинхронной коммуникации.
...
Система управления сообщениями с поддержкой различных протоколов, обеспечивает надежную доставку сообщений.

[🔼 К содержанию](#content)

---

#### Аналоги Kafka/RabbitMQ <a id="аналоги-kafka-rabbitmq"></a>  
Другие брокеры сообщений и очереди, поддерживающие асинхронное взаимодействие (например, ActiveMQ, Amazon SQS).
...
#### Redis <a id="redis"></a>  
Высокопроизводительное хранилище данных в памяти, используется для кэширования, сессий и хранения быстрых состояний.

[🔼 К содержанию](#content)

---

#### Hazelcast <a id="hazelcast"></a>  
Распределённая in-memory платформа для кэширования и вычислений, поддерживает кластеризацию и масштабируемость.
...
Открытая платформа автоматизации, которая позволяет создавать и запускать конвейеры сборки, тестирования и деплоя проектов.
...
Встроенная в GitLab система непрерывной интеграции и доставки, позволяющая автоматизировать тестирование и релизы.

[🔼 К содержанию](#content)

---

### 🛠️ Системы контроля версий и разработки

#### Git <a id="git"></a>  
Распределённая система контроля версий для отслеживания изменений в коде и совместной работы.
...
Веб-сервис для хостинга репозиториев Git с возможностями управления проектами и интеграции CI/CD.
...
Мощная IDE для разработки на Java и других языках с поддержкой автотестов, отладки и интеграций.
...
Один из самых популярных анализаторов сетевого трафика, позволяет просматривать и детально анализировать пакеты.
...
Прокси-сервер для отладки HTTP(S) трафика между компьютером и интернетом, часто используется для тестирования API.
...
Платный инструмент для анализа HTTP/HTTPS трафика с возможностями записи и повторного воспроизведения запросов.
...
#### Микросервисная архитектура (Spring Cloud, Kubernetes, Openshift или аналоги) <a id="микросервисная-архитектура"></a>  
Подход к построению приложений из набора небольших автономных сервисов. Spring Cloud — набор инструментов для разработки микросервисов на Java. Kubernetes и Openshift — платформы для оркестрации контейнеров и управления масштабированием.
...
#### Docker и контейнеризация <a id="docker-и-контейнеризация"></a>  
Технологии для упаковки приложений и их зависимостей в контейнеры, что обеспечивает переносимость и упрощает развертывание.
...
### 📚 Работа с документацией и таск-трекинг

#### Jira <a id="jira"></a>  
Система управления проектами и задачами, популярная в Agile-командах для отслеживания багов, историй и спринтов.
...
Платформа для совместной работы и документации, позволяет создавать базы знаний, спецификации и отчёты.
...
#### Английский Intermediate+ (для чтения технической документации) <a id="английский"></a>  
Уровень владения английским, достаточный для чтения и понимания технических материалов, документаций и общения с международной командой.
