# Содержание:
[Методы класса String](#task1)  
[Классы для работы со строками](#task2)  
[Методы класса String](#task1)  




## <a name="task1"></a>Методы класса String в Java 
...
# <a name="task2"></a>Классы для работы со строками в Java
