...
- **Строки**
  ...
  - [Задача 12: Разделить строку на числа и буквы, посчитать сумму чисел](#task12)
...
<a name="task12"></a>
## Задача 12: Разделить строку на числа и буквы, посчитать сумму чисел

**Вопрос:** Напишите программу на Java, которая принимает строку, выделяет из неё числа и буквы, считает сумму всех чисел и выводит результаты в виде двух массивов: один для чисел, другой для букв.
    ...
    public static void main(String[] args) {
        ...
        for (char c : input.toCharArray()) {
            if (Character.isDigit(c)) {
                numbers.append(c); // Собираем цифры
                sum += c - '0'; // Преобразуем цифру в число и добавляем к сумме
            } else if (Character.isLetter(c)) {
                letters.append(c); // Собираем буквы
            }
        }

        System.out.println("Исходная строка: " + input);
        System.out.println("Сумма чисел: " + sum);
        System.out.println("Буквы: " + letters.toString());
        System.out.println("Цифры: " + numbers.toString());
    }
}
```
Проходим по каждому символу строки с помощью `for-each`.
Если символ — цифра (`Character.isDigit`), добавляем её к сумме и собираем в `numbers`.
Если символ — буква (`Character.isLetter`), собираем её в `letters`.
Выводим результаты: исходную строку, сумму чисел, массив букв и массив цифр.
