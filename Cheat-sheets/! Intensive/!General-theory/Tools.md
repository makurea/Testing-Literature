...
TestLink — это инструмент для управления тестами. Он позволяет создавать тест-кейсы, организовывать их в тест-планы, отслеживать выполнение тестирования и генерировать отчёты. Поддерживает интеграцию с Jira и другими баг-трекинговыми системами.
...
Mantis — это система отслеживания багов с удобным интерфейсом и возможностью настройки прав доступа. Позволяет создавать задачи, назначать их исполнителям, отслеживать статус и комментировать ошибки. Поддерживает уведомления по email и интеграцию с различными CI/CD инструментами.
...
Redmine — мощный инструмент для управления проектами и задачами, который часто используется в тестировании. Поддерживает систему тикетов, ведение вики, управление репозиториями и интеграцию с TestRail и другими тест-менеджмент инструментами.
...
Bugzilla — один из старейших и наиболее гибких инструментов для отслеживания багов. Он позволяет организовывать баг-репорты по категориям, отслеживать статус исправлений, вести подробную историю изменений и интегрироваться с другими системами управления тестированием.
...
QASE — современная платформа для управления тест-кейсами и тест-планами. Поддерживает API-интеграцию, удобное построение отчетов, автоматизацию тестирования и работу в команде. Отлично подходит как для ручного, так и автоматизированного тестирования.
...
PractiTest — облачная система управления тестированием с гибкими настройками и возможностью интеграции с Jira, GitHub и CI/CD процессами. Позволяет отслеживать прогресс тестирования, связывать тест-кейсы с баг-репортами и автоматизировать часть процессов.
...
LightShot и Greenshot — удобные инструменты для создания скриншотов во время тестирования. Они позволяют выделять проблемные области, добавлять аннотации и быстро сохранять изображения для отчетов и баг-репортов.
...
XMind и FreeMind — инструменты для создания ментальных карт, которые помогают тестировщикам визуализировать тестовые сценарии, анализировать возможные пути использования продукта и организовывать тест-процессы.
