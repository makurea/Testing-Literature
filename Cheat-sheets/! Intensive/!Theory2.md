...
- **@Nested** — аннотация для создания вложенных тестовых классов, позволяющая организовать тесты в иерархии.
- **@DisplayName** — аннотация для задания человекочитаемого имени теста.
- **@ExtendWith** — аннотация для подключения расширений к тестам.
- **@Tag** — аннотация для назначения меток тестам, что позволяет фильтровать тесты при запуске.
- **@AssertThrows** — аннотация для проверки, что определенное исключение выбрасывается в тесте.
- **@NullSource** — аннотация для параметризованных тестов, позволяющая использовать `null` в качестве одного из параметров.
- **@EmptySource** — аннотация для параметризованных тестов, позволяющая использовать пустые коллекции или массивы в качестве параметров.
...
**BDD (Behavior-Driven Development)** — это подход к разработке ПО, направленный на создание общего понимания между разработчиками, тестировщиками и бизнес-аналитиками. Основная идея — писать спецификации (требования) в формате, понятном всем участникам проекта.
