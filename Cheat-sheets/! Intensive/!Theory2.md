...
- **descendant** — элементы-потомки.
- **parent** — родительский элемент.
- **following-sibling** — следующий соседний элемент.
- **preceding-sibling** — предыдущий соседний элемент.

Использование осей XPath может упростить поиск сложных элементов на странице.
