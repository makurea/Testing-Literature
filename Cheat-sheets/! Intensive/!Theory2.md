...
## [Архитектура фреймфорка](#архитектура)

- [паттерн Page Object](#page-object)
- [MVC](#mvc)
  
## [Логеры, репортеры, метрики](#логеры-репортеры)

- [Что такое логеры?](#page-object)
- [Что такое репортер?](#page-object)
- [Знания Allure reporter - аннотации](#allure)
- [Что такое метрики?](#mvc)

  
## [Автоматизация тестирования мобильных приложений](#мобилы)

- [Что такое Appium (Android/iOS)](#page-object)
- [Что такое Appium Inspector?](#)
- [Локаторы в Appium (Android/iOS)](#page-object)
- [Скоуп программ для запуска тестов(Android/iOS)](#allure)
- [Что такое: Kaspresso/Espresso/WebdriverIO](#allure)
  
## [Базы данных](#базы-данных)

- [Как организовать подключение к БД, какие инструменты нужно использовать (JDBC, Spring Data).](#page-object)
