...
**Стаб (Stub)**
Стаб — это простая замена настоящего объекта, которая просто возвращает заранее заданные данные. Он не проверяет, как именно с ним работают, а просто подставляет нужные значения.
...
**Мок (Mock)**
Мок — это более "умная" подмена объекта, которая не только возвращает данные, но и фиксирует, какие запросы к ней делали. Он позволяет проверять, сколько раз его вызвали и какие аргументы передали.
