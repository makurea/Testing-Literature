...
Тестирование — это процесс оценки программного обеспечения или системы для выявления дефектов и обеспечения качества продукта.
...
### 3. Где мы видим требования и ожидаемый результат?

Требования и ожидаемый результат видим в спецификации требований (SRS - Software Requirements Specification) и в документации по тест-кейсам.
...
### 4. Основные цели тестирования

- Актуальная информация по состоянию продукта
...
Документ, описывающий найденный дефект, включающий:
...
Документ, описывающий результаты тестирования, включающий:
...
### 7. QA и QC (продуктно- и процессо-ориентированный подход)

- QA (Quality Assurance) — процессо-ориентированный подход, обеспечивающий качество процессов.
- QC (Quality Control) — продуктно-ориентированный подход, обеспечивающий качество продукта.

[К содержанию](#content)

---

### 8. Валидация и верификация. Статическая и динамическая. Примеры

- Верификация (Verification) — процесс оценки, соответствуют ли разработки требованиям (например, ревизия документов).
- Валидация (Validation) — процесс оценки, соответствует ли продукт ожиданиям и требованиям пользователя (например, пользовательское тестирование).
- Статическая проверка — ревизия документов и кода без запуска программ.
- Динамическая проверка — тестирование программ через их выполнение.

[К содержанию](#content)

---

### 9. Верификация - документы, валидация - запуск, использование

- Верификация — проверка документации, кода.
- Валидация — проверка выполнения, запуск программ.

[К содержанию](#content)

---

### 10. 7 принципов тестирования
...
4. Скопление дефектов в одних местах.
